...
# --- 테스트 데이터: 발행 ---
MAINNET_NAME="SDSMainNet_${RUN_ID}"
MAINNET_TYPE="Besu"
MAINNET_ENDPOINT="http://localhost:9999"
MAINNET_CHAIN_ID=${RUN_ID}

SC_NAME="MySC_${RUN_ID}"
SC_SYMBOL="MS${SHORT_ID}"
SC_ISSUE_AMOUNT=5000000.0
...
RESERVE_FIAT_AMOUNT=2000000.0
RESERVE_MMF_AMOUNT=3000000.0
